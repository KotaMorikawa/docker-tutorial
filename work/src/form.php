        ...
        <div style="padding: 0 2rem 0 2rem; border: 2px solid #38F;">
          ...
          <form action="mail.php" method="post">
            <div style="margin-bottom: 1.5rem;">
              <input type="email" id="to" name="send_to" maxlength="40" placeholder="Send to" autofocus style="width: 100%; font-size: 1.25rem; padding: 0.375rem;" />
            </div>
            <div style="margin-bottom: 1.5rem;">
              <input type="text" id="sub" name="subject" maxlength="40" placeholder="Subject" style="width: 100%; font-size: 1.25rem; padding: 0.375rem;" />
            </div>
            <div style="margin-bottom: 1.5rem;">
